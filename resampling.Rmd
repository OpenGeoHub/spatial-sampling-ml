...
```{r eberg-allpnts, echo = TRUE, out.width = "90%", fig.cap = "All sampling points available for Ebergotzen case study."}
...
```{r eberg-grid-sample, echo = TRUE, out.width = "90%", fig.cap = "Resampling original points using `sample.grid` function, which produces a sample with similar properties such as SRS."}
...
```{r eberg-pred-erf, echo = TRUE, out.width = "90%", fig.cap = "Predictions of clay content: (left) ignoring spatial clustering effect on model, (right) after de-clustering of points."}
...
```{r eberg-iprob, echo = TRUE, out.width = "90%", fig.cap = "Occurrence probability for existing point samples for the Ebergotzen case study derived as an average between the kernel density and maxlike occurrence probabilities."}
...
```{r eberg-grid, echo = TRUE, out.width = "90%", fig.cap = "500 m grid for spatial resampling."}
plot(r.sp)
points(eberg.xy, pch="+", cex=.5)
```
...
```{r eberg-eml, echo = TRUE, out.width = "90%", fig.cap = "Predictions of clay content: (left) Ensemble ML with spatial blocking, (right) after de-clustring of points."}
...
```{r edgeroi-map, echo = TRUE, out.width = "90%", fig.cap = "The Edgeroi dataset consisting of 359 soil profiles."}
...
```{r edgeroi-grid-sample, echo = TRUE, out.width = "90%", fig.cap = "Resampling original points using `sample.grid` function for the Edgeroi dataset."}
...
```{r pred-soc, echo=FALSE, fig.cap="Predictions of soil organic carbon (in log-scale) based on Random Forest (RF) and Ensemble ML (EML).", out.width="100%"}
knitr::include_graphics("./img/edgeroi_predictions_SOC_5cm.png")
```
...
```{r edgeroi-var-eml, echo = TRUE, out.width = "90%", fig.cap = "Prediction errors for the soil organic carbon content based on the forestError package and Ensemble ML."}
