...
#>     /tmp/RtmpiprBNs/file10366f2181bf/h2o_tomislav_started_from_r.out
#>     /tmp/RtmpiprBNs/file10362f8c5018/h2o_tomislav_started_from_r.err
#> 
#> 
#> Starting H2O JVM and connecting: .. Connection successful!
#> 
#> R is connected to the H2O cluster: 
#>     H2O cluster uptime:         1 seconds 972 milliseconds 
#>     H2O cluster timezone:       Europe/Amsterdam 
#>     H2O data parsing timezone:  UTC 
#>     H2O cluster version:        3.30.0.1 
#>     H2O cluster version age:    1 year and 9 months !!! 
...
#> Your H2O cluster version is too old (1 year and 9 months)!
...
#>  $ PC1: num  3.25 -2.75 -1.86 -4.95 -3.63 ...
#>  $ PC2: num  -0.0491 -4.2362 2.5881 2.1994 3.3685 ...
#>  $ PC3: num  0.796 -3.329 5.757 -0.688 0.277 ...
#>  $ PC4: num  0.385 -2.563 4.664 -1.098 3.236 ...
