...
plot.map(df=log1p(raster(edgeroi.error[c("inv.prob")])), points = coordinates(edgeroi.sp),points2 =as(pnts.new, "SpatialPoints") , fill = rev(terrain.colors(10)), title="Uncertainty guided 2nd round sampling")
